...
<form class="form-contact contact_form" method="post" id="contactForm" novalidate="novalidate">
                        <div class="row">
                           ...
                           <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label><b style="color: #ff0000; font-size: 18px;">Agent Business Name.:</b></label>
                                    <input class="form-control valid" name="agtbn" id="agtbn" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Input your Business Name'" placeholder="Input your Business Name">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                        ...
                        <p style="font-size: 15px;"><a style="color: #000000;" href="./signin">Got a space | </a> <a style="color: #ff0000;" href="./forgot">Forgot Password?</a></p>
                          <div class="form-group mt-3 pl-5 col-lg-4">
                            <button type="button" id="landlord" onclick="agtReg();" class="button button-contactForm boxed-btn">Next</button>                            
                        </div>
                    </form>
