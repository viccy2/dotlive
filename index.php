                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 col-md-12">
                            <div class="hero__caption">
                                ...
                                <p data-animation="fadeInLeft" data-delay="0.4s">Get affordable, cheap and beautiful
                                    hostels for living, meetups and bootcamps from the comfort of your homes.</p>
                                <a href="./apartments" class="btn hero-btn" data-animation="fadeInLeft"
                                    data-delay="0.7s">Browse Apartments</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="properties pb-20">
                    <div class="properties__card">
                        <div class="properties__img overlay1">
                            <a href="#"><img style="width: 100%; height: 315px;"
                                    src="upload/apartment/<?php echo $row['pix'] ?>" alt="DotLive"></a>
                        </div>
                        <div class="properties__caption">
                            ...
                            <a href="./details?id=<?php echo $row['apt'] ?>" class="border-btn border-btn2">View More
                                Details</a>
                        </div>
            ...
            <div class="left-content2">
                ...
                <div class="section-tittle section-tittle2 mb-20">
                    <div class="front-text">
                        ...
                        <p>The automated process on our website takes you through all process in ensuring that you get
                            the perfect apartment for your temporary stay.</p>
