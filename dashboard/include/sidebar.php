<!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href=".././" class="brand-link">
      <img src="../assets/img/logo/2.png" alt="DotLive" class="brand-image elevation-3"
           style="opacity: 0.8">
           <span style="font-size: 12px;" class="brand-text font-weight-light"><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;from DotEightPlus</span>
    </a>
...
$category   = $row['category'];
  ?>    
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="./profile" class="d-block text-center" style="text-transform: capitalize;">Welcome <?php echo $row['name']; ?></a>
