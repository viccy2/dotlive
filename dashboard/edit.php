...
$sql = "SELECT * FROM apartment where `uploader` = '$r' AND `apt` = '$data'";
$res = query($sql);
...
$row = mysqli_fetch_array($res);
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" id="suite" class="form-control" value="<?php echo $data ?>" disabled>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select id="apt" class="form-control" required>
                                        <option id="apt"><?php echo $row['apartment']; ?></option>
                   ...
                   <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select id="water" class="form-control" required>
                                        <option id="apt"><?php echo $row['water']; ?></option>
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select id="power" class="form-control" required>
                                        <option id="apt"><?php echo $row['power']; ?></option>
                 ...
                 <div class="col-sm-6">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control">
                                        <option id="apt"><?php echo $row['state']; ?></option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>Email.:</label>
                        <input type="text" id="email" class="form-control" value="<?php echo $r ?>" placeholder="370" disabled>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <!-- select -->
                      <div class="form-group">
                        ...
                        <select id="toi" class="form-control" required>
                                        <option id="apt"><?php echo $row['toilet']; ?></option>
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="text" id="twn" value="<?php echo $row['location'] ?>" class="form-control" placeholder="30000" required>
                      </div>
                    </div>
                    <div class="col-sm-12">
                      <!-- textarea -->
 ...
 <li>Please Kindly go back and recheck all details for any errors. DotLive shall not be responsible for any mistakes.</li>
                  ...
                  <input type="button" name="aptmentUpl" value="Next" id="edtaptmentUpl" class="btn btn-success float-right">
                </form>
              </div>
              <!-- /.card-body -->
            </div>
