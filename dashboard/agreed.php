                ...
                <div class="col-12">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="suite" class="form-control"
                                                value="<?php echo 'DotLive-'.rand(0, 999).''?>" disabled>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="loc" class="form-control" required>
                                                <option id="loc" name="loc">Abubakar Tafawa Balewa University, Bauchi
                                                </option>
                                                ...
                                                <option id="loc" name="loc">Federal University of Petroleum Resources,
                                                    Effurun</option>
                                                <option id="loc" name="loc">Federal University of Technology, Akure
                                                </option>
                                                <option id="loc" name="loc">Federal University of Technology, Minna
                                                </option>
                                                <option id="loc" name="loc">Federal University of Technology, Owerri
                                                </option>
                                                <option id="loc" name="loc">Federal University, Dutse, Jigawa State
                                                </option>
                                                <option id="loc" name="loc">Federal University, Dutsin-Ma, Katsina
                                                </option>
                                                <option id="loc" name="loc">Federal University, Kashere, Gombe State
                                                </option>
                                                <option id="loc" name="loc">Federal University, Lafia, Nasarawa State
                                                </option>
                                                <option id="loc" name="loc">Federal University, Lokoja, Kogi State
                                                </option>
                                                <option id="loc" name="loc">Alex Ekwueme University, Ndufu-Alike, Ebonyi
                                                    State</option>
                                                <option id="loc" name="loc">Federal University, Otuoke, Bayelsa</option>
                                                <option id="loc" name="loc">Federal University, Oye-Ekiti, Ekiti State
                                                </option>
                                                <option id="loc" name="loc">Federal University, Wukari, Taraba State
                                                </option>
                                                ...
                                                <option id="loc" name="loc">Michael Okpara University of Agricultural
                                                    Umudike</option>
                                                <option id="loc" name="loc">Modibbo Adama University of Technology, Yola
                                                </option>
                                                <option id="loc" name="loc">National Open University of Nigeria, Lagos
                                                </option>
                                                ...
                                                <option id="loc" name="loc">Federal University of Agriculture, Abeokuta
                                                </option>
                                                ...
                                                <option id="loc" name="loc">Nigerian Maritime University Okerenkoko,
                                                    Delta State</option>
                                                <option id="loc" name="loc">Air Force Institute of Technology, Kaduna
                                                </option>
                                                ...
                                                <option id="loc" name="loc">Akwa Ibom State University, Ikot Akpaden
                                                </option>
                                                <option id="loc" name="loc">Ambrose Alli University, Ekpoma</option>
                                                <option id="loc" name="loc">Chukwuemeka Odumegwu Ojukwu University, Uli
                                                </option>
                                                <option id="loc" name="loc">University of Jos</option>
                                                <option id="loc" name="loc">University of Lagos</option>
                                                <option id="loc" name="loc">University of Maiduguri</option>
                                                ...
                                                <option id="loc" name="loc">Cross River State University of Technology,
                                                    Calabar</option>
                                                ...
                                                <option id="loc" name="loc">Enugu State University of Science and
                                                    Technology, Enugu</option>
                                                <option id="loc" name="loc">Ibrahim Badamasi Babangida University, Lapai
                                                </option>
                                                <option id="loc" name="loc">Ignatius Ajuru University of
                                                    Education,Rumuolumeni</option>
                                                <option id="loc" name="loc">Imo State University, Owerri</option>
                                                <option id="loc" name="loc">Sule Lamido University, Kafin Hausa, Jigawa
                                                </option>
                                                <option id="loc" name="loc">Kaduna State University, Kaduna</option>
                                                <option id="loc" name="loc">Kano University of Science &amp; Technology,
                                                    Wudil</option>
                                                <option id="loc" name="loc">Kebbi State University of Science and
                                                    Technology, Aliero</option>
                                                <option id="loc" name="loc">Kwara State University, Ilorin</option>
                                                <option id="loc" name="loc">Kogi State University Anyigba</option>
                                                <option id="loc" name="loc">Ladoke Akintola University of Technology,
                                                    Ogbomoso</option>
                                                <option id="loc" name="loc">Ondo State University of Science and
                                                    Technology Okitipupa</option>
                                                <option id="loc" name="loc">River State University</option>
                                                <option id="loc" name="loc">Olabisi Onabanjo University, Ago Iwoye
                                                </option>
                                                ...
                                                <option id="loc" name="loc">Tai Solarin University of Education Ijebu
                                                    Ode</option>
                                                <option id="loc" name="loc">Umar Musa Yar&#8217; Adua University Katsina
                                                </option>
                                                ...
                                                <option id="loc" name="loc">Oyo State Technical University Ibadan
                                                </option>
                                                <option id="loc" name="loc">Ondo State University of Medical Sciences
                                                </option>
                                                <option id="loc" name="loc">Edo University Iyamo</option>
                                                <option id="loc" name="loc">Eastern Palm University Ogboko, Imo State
                                                </option>
                                                <option id="loc" name="loc">University of Africa Toru Orua, Bayelsa
                                                    State</option>
                                                <option id="loc" name="loc">Bornu State University, Maiduguri</option>
                                                <option id="loc" name="loc">Moshood Abiola University of Science and
                                                    Technology Abeokuta</option>
                                                <option id="loc" name="loc">Gombe State University of Science and
                                                    Technology</option>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="tel" value="<?php echo $row['tel'] ?>"
                                                class="form-control" placeholder="370" disabled>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="email" class="form-control"
                                                value="<?php echo $row['email'] ?>" placeholder="370" disabled>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="price" class="form-control" placeholder="30000"
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-12">
                                        <!-- textarea -->
                                        <div class="form-group">
                                            <label>Apartment Description<small><span
                                                        style="color: red;"></span></small></label>
                                            <textarea id="desc" class="form-control" rows="3"
                                                placeholder="Tell more about your apartment" required></textarea>
                                        </div>
                                    </div>
                                </div>
                 ...
                 ?>
                  ...
                  ?>
                                <div class="form-group">
                                    <label class="col-form-label" for="inputWarning">Account Number.:</label>
                                    <input type="text" id="acct" value="<?php echo $row['acct'] ?>"
                                        class="form-control is-warning" id="inputWarning" disabled>
                                </div>
                                <?php
                }
                  ...
                  ?>
                   ...
                   ?>
                                <div class="form-group">
                                    <label>Bank Name.:</label>
                                    <input type="text" id="bank" class="form-control is-warning" id="inputWarning"
                                        value="<?php echo $row['bank'] ?>" disabled>
                                </div>
                                <?php
                   }
                   ?>
                                <br /><br />
                                <ul style="color: red;">
                                    <li>Please Kindly go back and recheck all details for any errors. DotLive shall not
                                        be responsible for any mistakes.</li>

                                </ul>

                                <input type="button" name="aptmentUpl" value="Next" id="aptmentUpl"
...
<script async
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD0Kbtqg5USaTiHCWLdipwub49-cVuZilY&libraries=places&callback=initMap">
</script>
</body>
